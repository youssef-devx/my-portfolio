...
export default function Logo({ dark }) {
  ...
  return (
    <svg width="80" height="40" viewBox="0 0 285.7 70.7" xmlns="http://www.w3.org/2000/svg">
      <g id="svgGroup" strokeLinecap="round" fillRule="evenodd" fontSize="9pt" fill={fill} style={{ fill: fill }}>
        <motion.path
          variants={icon}
          initial="hidden"
          animate="visible"
          fill={fill}
          transition={{ duration: 1, repeat: dark && Infinity, repeatType: dark && "loop" }}
